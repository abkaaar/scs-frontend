...
const SuperAdminClearanceRequests = () => {
  ...
  const columns = [
    ...
    {
      title: 'Matric Number',
      dataIndex: ['student', 'matricNo'],
      key: 'matricNo',
    },
    {
      title: 'Department',
      dataIndex: ['student', 'departmentName'],
      key: 'department',
    },
    {
      title: 'Progress',
      ...
      render: (_, record) => (
        <Progress 
          percent={calculateProgress(record.approvals)} 
          size="small" 
          status={record.status === 'APPROVED' ? 'success' : 'active'}
        />
      ),
    },
    {
  ...
  return (
    <div style={{ 
      ...
      >
        ...
        <Breadcrumb.Item>
          <FileTextOutlined /> Clearance Requests
        </Breadcrumb.Item>
      </Breadcrumb>
            ...
            >
              <div style={{ 
                ...
                <div>
                  ...
                  <Text type="secondary">{currentRequest.student.matricNo}</Text>
                </div>
              </div>
...
export default SuperAdminClearanceRequests;
